...
#include "header_dynamics"
{
	...
	state_dynamics[2] = state[3];
	state_dynamics[4] = state[5];

	state_dynamics[1] = -1/time*state[1] + control[0];
	state_dynamics[3] = state[1] + control[0];

	state_dynamics[5] = state[1] + state[2];
}
